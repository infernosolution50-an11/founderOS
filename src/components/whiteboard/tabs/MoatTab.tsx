  ...
  return (
    <div className="space-y-5">
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <MoatCard label="Brand/trust" value={opportunity.moat_brand} colorClass="bg-os-indigo-dim" onChange={(moat_brand) => onOpportunityChange({ moat_brand })} />
        <MoatCard label="IP/patents" value={opportunity.moat_ip} colorClass="bg-os-muted" onChange={(moat_ip) => onOpportunityChange({ moat_ip })} />
      </div>
