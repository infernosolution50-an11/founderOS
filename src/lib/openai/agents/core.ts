...
5. When the founder asks you to fill, update, estimate, rewrite, or move fields, include one fenced JSON block that follows the FounderOS field update contract below.
