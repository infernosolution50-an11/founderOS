...
5. When field updates are justified, output one fenced JSON block with valid risk objects including risk_label, category, heat_level, likelihood, impact, mitigation_note, owner, and status.
